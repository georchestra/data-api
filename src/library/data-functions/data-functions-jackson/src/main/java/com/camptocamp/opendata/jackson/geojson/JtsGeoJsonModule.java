...
public class JtsGeoJsonModule extends SimpleModule {
    ...
    static class GeometrySerializer extends StdSerializer<Geometry> {
        ...
        public @Override void serializeWithType(Geometry value, JsonGenerator gen, SerializerProvider serializers,
        ...
        public @Override void serialize(Geometry value, JsonGenerator gen, SerializerProvider serializers)
                throws IOException {
    ...
    static class GeometryDeserializer<T extends Geometry> extends JsonDeserializer<T> {
        ...
        private ArrayNode getCoordinatesNode(ObjectNode geometryNode) {
            ...
            if (coordinatesNode == null || coordinatesNode.isNull()) {
                ...
                throw new IllegalArgumentException(
                        "Invalid 'coordinates' field type, expected ArrayNode, got " + coordinatesNode.getNodeType());
            }
            return coordinates;
        }
        ...
        private MultiPolygon readMultiPolygon(ObjectNode geometryNode, int dimensions, boolean hasM) {
            ...
            Polygon[] polygons = IntStream.range(0, coordinates.size()).mapToObj(i -> (ArrayNode) coordinates.get(i))
        ...
        private Point readPoint(ObjectNode geometryNode, int dimensions, boolean hasM) {
            ...
            CoordinateSequence coordinate = geometryFactory.getCoordinateSequenceFactory().create(1, dimensions,
                    hasM ? 1 : 0);
