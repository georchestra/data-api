...
public class GeoRecordToGeoJsonFeatureModule extends SimpleModule {
    ...
    static class GeodataRecordSerializer extends StdSerializer<GeodataRecord> {
        ...
        public @Override void serializeWithType(GeodataRecord record, JsonGenerator gen, SerializerProvider serializers,
                TypeSerializer typeSer) throws IOException {

            WritableTypeId typeIdDef = typeSer.writeTypePrefix(gen, typeSer.typeId(record, JsonToken.START_OBJECT));
        ...
        public @Override void serialize(GeodataRecord record, JsonGenerator generator, SerializerProvider serializers)
                throws IOException {
        ...
        private void serializeContent(GeodataRecord record, JsonGenerator generator) throws IOException {
        ...
        private void writeGeometryProperty(JsonGenerator generator, GeometryProperty geometryProp) throws IOException {
    ...
    static class GeodataRecordDeserializer extends JsonDeserializer<GeodataRecord> {
        ...
        private GeometryProperty readGeometryProperty(JsonParser p) throws IOException {
            ...
            if (userData instanceof Map) {
                ...
                if (extraProps.size() == 2 && extraProps.containsKey("@name") && extraProps.containsKey("@srs")) {
